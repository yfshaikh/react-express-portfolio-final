  ...
  useEffect(() => {
    async function fetchPost() {
      try {
        ...
        if (data.file) {
          await fetchImage(data.file);
        }

        setLoading(false); // Set loading to false after post and image are fetched
      } catch (error) {
  ...
  return (
    <>
      ...
      <div className='post'>
        ...
        <div className='post-container'>{image && <img src={image} alt={post.title} />}</div>
        <div className='post-container' id='post-body'>
